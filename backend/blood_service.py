...
# Prompt file path
PROMPT_FILE_PATH = r"app\templates\blood_test\blood_test_prompt.txt" # Fill this out
...
if __name__ == '__main__':
    ...
    create_pdf(test_text, pdf_filename=r"app\templates\blood_test\blood_test_report_output2.pdf")
